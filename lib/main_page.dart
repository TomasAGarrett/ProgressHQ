...
class MainPage extends StatefulWidget {
  ...
  // this is where you can pass in data to the page
  // for example, if you want to pass in a user's name, you can do it here
  ...
  Widget build(BuildContext context) {
    ...
    */
    return Scaffold(
      ...
      body: _pages[_selectedIndex], // this is where we display the pages
      bottomNavigationBar: MyBottomNavBar(
        onTabChange: (index) => navigateBottomBar(
            index), // this is where we update the selected index
      ),
    );
  }
}
